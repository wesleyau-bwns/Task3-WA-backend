...
class UserAuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $result = $this->authService->register($validated, 'user');
    ...
    public function login(Request $request)
    {
        ...
        $result = $this->authService->login($validated['email'], $validated['password'], 'user');
    ...
    public function refresh(Request $request)
    {
        ...
        $token = $this->authService->refresh($refreshToken, 'user-api');
    ...
    {
        $this->authService->logout($request->user('user-api'));
